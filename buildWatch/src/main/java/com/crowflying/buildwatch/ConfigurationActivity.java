...
public class ConfigurationActivity extends TrackedPreferenceActivity implements
    ...
    private class ConfigureAppFromQRCode extends
         ...
         *
         * @param json    The JSON from the QR code.
         * @param jsonKey The key of where to find the value in the JSON.
         * @param editor  The Editor to store the configuration to.
         * @param prefKey The key to store the config value.
